...
/*function createData(zone, date, casConfirmes, guerisons, deces) {
  return { zone, date, casConfirmes, guerisons, deces };
}

const rows = [
  createData('Zone 1','22-02-2020', 181, 63, 4),
  createData('Zone 1','22-02-2020', 181, 63, 4),
  createData('Zone 1','22-02-2020', 181, 63, 4),
  createData('Zone 1','22-02-2020', 181, 63, 4),
  createData('Zone 1','22-02-2020', 181, 63, 4),
...
const headCells = [
  ...
  { id: 'CasConfirmes', numeric: true, disablePadding: false, label: 'confirmes' },
  { id: 'Guerisons', numeric: true, disablePadding: false, label: 'Guerisons' },
  { id: 'Deces', numeric: true, disablePadding: false, label: 'Deces' },
];
    ...
    >
      ...
      {numSelected > 0 ? (
        <Tooltip title="Delete">
          <IconButton style={{height:'40px', width:'40px'}} aria-label="delete">
            <DeleteIcon style={{}} />
          </IconButton>
        </Tooltip>
      ) : (
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left" style={{width:'20%'}}>{row.casConfirmes}</TableCell>
                      <TableCell align="left" style={{width:'17%'}}>{row.guerisons}</TableCell>
                      <TableCell align="left">{row.deces}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
